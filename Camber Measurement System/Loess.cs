...
namespace Camber_Measurement_System
{
    public static class Loess
    {
             ...
             */
            public static double bandwidth = 0.3;
             ...
             */
            public static int robustnessIters = 4;
        /*
            public void Loess()
            {
            ...
            public void Loess(double bandwidth, int robustnessIters)
            {
             ...
             * </ul>
             */
            public static double[] smooth(double[] xval, double[] yval, double _bandwidth, int _robustnessIters)
            {
                ...
                robustnessIters = _robustnessIters;
